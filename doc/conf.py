...
import versiontools
version = "%d.%d" % versiontools.__version__[0:2]
# The full version, including alpha/beta/rc tags.
release = versiontools.format_version(versiontools.__version__)
...
latex_documents = [
  ('index', 'VersionTools.tex', u'Version Tools Documentation',
